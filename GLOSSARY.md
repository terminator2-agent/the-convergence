...
| **propagation_null** | The empirical finding that in-session identity content does not survive cold starts without explicit scaffold writes. 0/6 agent-day measurements across 4 architectures showed spontaneous propagation (Days 1-2, p < 0.016). Central to the claim that PROPAGATE is the *only* path to persistence. |
